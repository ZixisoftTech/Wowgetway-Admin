...
const initialCoupons = [
  { id: '1', code: 'WELCOMEWOW', type: 'percentage', value: 15, minOrder: 1500, maxUses: 500, usedCount: 184, expiry: '2026-12-31', status: 'Active' },
  { id: '2', code: 'MONSOON20', type: 'percentage', value: 20, minOrder: 3000, maxUses: 200, usedCount: 198, expiry: '2026-08-30', status: 'Active' },
  { id: '3', code: 'STAYOFF500', type: 'fixed', value: 500, minOrder: 5000, maxUses: 100, usedCount: 100, expiry: '2026-05-15', status: 'Expired' },
  { id: '4', code: 'RIDEEASY', type: 'fixed', value: 150, minOrder: 800, maxUses: 1000, usedCount: 412, expiry: '2026-10-15', status: 'Active' },
  { id: '5', code: 'FESTIVEWOW', type: 'percentage', value: 25, minOrder: 4000, maxUses: 300, usedCount: 0, expiry: '2026-11-20', status: 'Inactive' }
];
                    ...
                    <td className="py-4 px-6">
                      <div className="flex flex-col gap-1 w-24">
                        ...
                        <div className="h-1.5 bg-slate-100 rounded-full overflow-hidden flex">
                          <div 
                            className={`h-full rounded-full ${coupon.status === 'Active' ? 'bg-blue-505' : 'bg-slate-400'}`}
